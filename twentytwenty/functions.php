 ...
 */
//add_action( 'wp_enqueue_scripts', 'alex_custom_style_css' );
//
//function alex_custom_style_css() {
//
//    wp_enqueue_style('style', get_stylesheet_uri());
//    wp_enqueue_style('style', get_template_directory_uri() . '/assets/css/bootstrap.css' );
//    wp_enqueue_style('style', get_template_directory_uri() . '/assets/css/editor-style-block.css' );
//    wp_enqueue_style('style', get_template_directory_uri() . '/assets/css/editor-style-block-rtl.css' );
//    wp_enqueue_style('style', get_template_directory_uri() . '/assets/css/editor-style-classic.css' );
//    wp_enqueue_style('style', get_template_directory_uri() . '/assets/css/editor-style-classic-rtl.css' );
//}
